...
>
<div
  class="swiper-wrapper row cols-xl-4 cols-md-3 cols-sm-2 cols-1"
>
  <div
  ...
  >
    ...
    <div class="icon-box-content">
      ...
      <p>{{ $setting && $setting->phone ? $setting->phone : '' }}</p>
    </div>
  </div>
  <div
    class="swiper-slide icon-box text-center icon-box-primary"
  >
    ...
    <div class="icon-box-content">
      ...
      <p>{{ $setting && $setting->address ? $setting->address : '' }}</p>
    </div>
  </div>
  <div
    class="swiper-slide icon-box text-center icon-box-primary"
  >
    ...
    <div class="icon-box-content">
      ...
      <p>{{ $setting && $setting->established ? $setting->established : '' }}</p>
    </div>
  </div>
</div>
</div>
...
<div class="col-lg-6 mb-8">
  <img
      src="{{ $setting && $setting->contact_us_img ? $setting->contact_us_img : '' }}"
      alt="contact"
      width="500"
      height="400"
  />
